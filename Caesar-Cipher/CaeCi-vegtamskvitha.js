...
function EnactEnigma(message, key) {
  ...
  for (let i = 0; i < message.length; i++) {
        ...
        {
            code -= 65; //Wenn das Symbol außerhalb des Unicodes liegt, machen wir - nichts.
            code = mod(code + key, 26); //und hierfür haben wir mod definiert;immer noch nicht ganz sicher, wie genau die Mathematik dahinter funktioniert. Sorgt aber letztenendes dafür, daß, zusammen mit dem Key, das Alphabet verschoben wird.
            code += 65; //Wenn das Symbol außerhalb des Unicodes liegt, machen wir - nichts.
        }
